...
public class FragmentActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            this.mFragments.restoreAllState(savedInstanceState.getParcelable("android:support:fragments"), nc != null ? nc.fragments : null);
        }
    ...
    public View onCreateView(String name, Context context, AttributeSet attrs) {
        ...
        String fname = attrs.getAttributeValue(fragment, "class");
        TypedArray a = context.obtainStyledAttributes(attrs, FragmentTag.Fragment);
        if (fname == null) {
            fname = a.getString(containerId);
        }
        int id = a.getResourceId(z, i);
        ...
        if (containerId == i && id == i && tag == null) {
        ...
        if (fragment == null && containerId != i) {
        ...
        if (fragment == null) {
            ...
            this.mFragments.addFragment(fragment, z);
    ...
    public boolean onPreparePanel(int featureId, View view, Menu menu) {
        ...
        if (this.mOptionsMenuInvalidated) {
            this.mOptionsMenuInvalidated = z;
            menu.clear();
    ...
    public final Object onRetainNonConfigurationInstance() {
        ...
        nci.activity = hashMap;
        nci.custom = custom;
        nci.children = hashMap;
    ...
    protected void onStart() {
        ...
        super.onStart();
        this.mStopped = z;
        this.mReallyStopped = z;
        this.mHandler.removeMessages(z2);
        if (!this.mCreated) {
            this.mCreated = z2;
        ...
        if (!this.mLoadersStarted) {
            this.mLoadersStarted = z2;
            if (this.mLoaderManager != null) {
                this.mLoaderManager.doStart();
            } else if (!this.mCheckedForLoaderManager) {
                this.mLoaderManager = getLoaderManager(-1, this.mLoadersStarted, z);
            }
            this.mCheckedForLoaderManager = z2;
        }
