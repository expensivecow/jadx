...
public class ShareCompat {
    ...
    public static class IntentBuilder {
        ...
        public Intent getIntent() {
            ...
            if (this.mStreams == null || this.mStreams.size() <= needsSendMultiple) {
                needsSendMultiple = z;
            }
            ...
            if (!needsSendMultiple && isSendMultiple) {
                ...
                if (this.mStreams == null || this.mStreams.isEmpty()) {
                    ...
                    this.mIntent.putExtra("android.intent.extra.STREAM", (Parcelable) this.mStreams.get(z));
                }
        ...
        private void combineArrayExtra(String extra, ArrayList<String> add) {
            ...
            if (currentAddresses != null) {
                System.arraycopy(currentAddresses, i, finalAddresses, add.size(), currentLength);
            }
        ...
        private void combineArrayExtra(String extra, String[] add) {
            ...
            if (old != null) {
                System.arraycopy(old, i, result, i, oldLength);
            }
            System.arraycopy(add, i, result, oldLength, add.length);
        ...
        private static void withinStyle(StringBuilder out, CharSequence text, int start, int end) {
            ...
            while (i < end) {
                ...
                if (c2 == '<') {
                    ...
                    while (i + 1 < end && text.charAt(i + 1) == c) {
                        out.append("&nbsp;");
                        i++;
                    }
                    out.append(c);
