...
public class DialogFragment extends Fragment implements OnCancelListener, OnDismissListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            this.mStyle = savedInstanceState.getInt("android:style", z2);
            this.mTheme = savedInstanceState.getInt("android:theme", z2);
            this.mCancelable = savedInstanceState.getBoolean("android:cancelable", z);
