...
public class Fragment implements ComponentCallbacks, OnCreateContextMenuListener {
    ...
    public LoaderManager getLoaderManager() {
        ...
        this.mLoaderManager = this.mActivity.getLoaderManager(this.mIndex, this.mLoadersStarted, z);
        return this.mLoaderManager;
    }
    ...
    void initState() {
        LoaderManagerImpl loaderManagerImpl = null;
        boolean z = false;
        this.mIndex = -1;
        this.mWho = loaderManagerImpl;
        this.mAdded = z;
        this.mRemoving = z;
        this.mResumed = z;
        this.mFromLayout = z;
        ...
        this.mFragmentManager = loaderManagerImpl;
        this.mActivity = loaderManagerImpl;
        this.mFragmentId = z;
        this.mContainerId = z;
        this.mTag = loaderManagerImpl;
        this.mHidden = z;
        this.mDetached = z;
        this.mRetaining = z;
