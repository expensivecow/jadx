...
public class LongSparseArray<E> implements Cloneable {
    ...
    public void put(long key, E value) {
        int i = 0;
        int i2 = binarySearch(this.mKeys, i, this.mSize, key);
        if (i2 >= 0) {
        ...
        if (i2 >= this.mSize || this.mValues[i2] != DELETED) {
            if (this.mGarbage && this.mSize >= this.mKeys.length) {
                gc();
                i2 = binarySearch(this.mKeys, i, this.mSize, key) ^ -1;
            }
            if (this.mSize >= this.mKeys.length) {
                int n = idealLongArraySize(this.mSize + 1);
                long[] nkeys = new long[n];
                Object[] nvalues = new Object[n];
                System.arraycopy(this.mKeys, i, nkeys, i, this.mKeys.length);
                System.arraycopy(this.mValues, i, nvalues, i, this.mValues.length);
                this.mKeys = nkeys;
