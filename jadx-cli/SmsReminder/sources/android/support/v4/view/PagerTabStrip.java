...
public class PagerTabStrip extends PagerTitleStrip {
    ...
    public PagerTabStrip(Context context, AttributeSet attrs) {
        ...
        this.mDrawFullUnderlineSet = z2;
        this.mIndicatorColor = this.mTextColor;
        this.mTabPaint.setColor(this.mIndicatorColor);
        float density = context.getResources().getDisplayMetrics().density;
        this.mIndicatorHeight = (int) ((3.0f * density) + f);
        this.mMinPaddingBottom = (int) ((6.0f * density) + f);
        this.mMinTextSpacing = (int) (64.0f * density);
        this.mTabPadding = (int) ((16.0f * density) + f);
        this.mFullUnderlineHeight = (int) ((1.0f * density) + f);
        this.mMinStripHeight = (int) ((32.0f * density) + f);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        this.mTabPaint.setColor((this.mTabAlpha << 24) | (this.mIndicatorColor & i));
        canvas.drawRect((float) left, (float) top, (float) right, (float) bottom, this.mTabPaint);
        if (this.mDrawFullUnderline) {
            this.mTabPaint.setColor(-16777216 | (this.mIndicatorColor & i));
