...
public class ViewPager extends ViewGroup {
    ...
    class MyAccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
            ...
            if (ViewPager.this.mAdapter == null || ViewPager.this.mAdapter.getCount() <= z) {
                z = false;
            }
    ...
    public void setAdapter(PagerAdapter adapter) {
        ...
        if (this.mAdapter != null) {
            if (this.mObserver == null) {
                this.mObserver = new PagerObserver(this, classLoader);
            }
            ...
            if (this.mRestoredCurItem >= 0) {
                ...
                setCurrentItemInternal(this.mRestoredCurItem, z2, z);
    ...
    public void setCurrentItem(int item) {
        ...
        setCurrentItemInternal(item, z, z2);
    }

    public void setCurrentItem(int item, boolean smoothScroll) {
        boolean z = false;
        this.mPopulatePending = z;
        setCurrentItemInternal(item, smoothScroll, z);
    }
    ...
    void setCurrentItemInternal(int item, boolean smoothScroll, boolean always, int velocity) {
        ...
        if (this.mAdapter == null || this.mAdapter.getCount() <= 0) {
            ...
            if (item > this.mCurItem + pageLimit || item < this.mCurItem - pageLimit) {
                for (int i = 0; i < this.mItems.size(); i++) {
                    ((ItemInfo) this.mItems.get(i)).scrolling = dispatchSelected;
                }
            }
            ...
            if (smoothScroll) {
                smoothScrollTo(destX, z, velocity);
    ...
    public void setOffscreenPageLimit(int limit) {
        int i = 1;
        if (limit < i) {
            Log.w("ViewPager", "Requested offscreen page limit " + limit + " too small; defaulting to " + i);
            limit = 1;
        }
    ...
    void dataSetChanged() {
            ...
            if (newPos != -1) {
                if (newPos == -2) {
                    ...
                    if (this.mCurItem == ii.position) {
                        newCurrItem = Math.max(z2, Math.min(this.mCurItem, this.mAdapter.getCount() - 1));
                        needPopulate = true;
                    }
        ...
        if (needPopulate) {
            ...
            setCurrentItemInternal(newCurrItem, z2, z);
            requestLayout();
        }
    }
    ...
    void populate(int newCurrentItem) {
        ...
        if (this.mAdapter != null && !this.mPopulatePending && getWindowToken() != null) {
            ...
            if (curItem != null) {
                ...
                float leftWidthNeeded2 = 2.0f - curItem.widthFactor;
                ...
                while (pos2 >= 0) {
                    if (extraWidthLeft2 < leftWidthNeeded2 || pos2 >= startPos) {
                        ...
                        if (pos2 == ii.position && !ii.scrolling) {
                ...
                if (extraWidthRight2 < 2.0f) {
                    ...
                    while (pos2 < N) {
                        if (extraWidthRight2 < 2.0f || pos2 <= endPos) {
                            if (ii == null || pos2 != ii.position) {
                                ii = addNewItem(pos2, itemIndex2);
                                itemIndex2++;
    ...
    private boolean isGutterDrag(float x, float dx) {
        float f = 0.0f;
        return (x < ((float) this.mGutterSize) && dx > f) || (x > ((float) (getWidth() - this.mGutterSize)) && dx < f);
    }
    ...
    public void draw(Canvas canvas) {
        ...
        if (overScrollMode == 0 || (overScrollMode == i && this.mAdapter != null && this.mAdapter.getCount() > i)) {
            int restoreCount;
            int height;
            int width;
    ...
    public boolean beginFakeDrag() {
        ...
        MotionEvent ev = MotionEvent.obtain(time, time, z2, f, f, z2);
        this.mVelocityTracker.addMovement(ev);
        ev.recycle();
    ...
    public void endFakeDrag() {
        ...
        if (this.mFakeDragging) {
            ...
            int scrollX = getScrollX();
            ItemInfo ii = infoForCurrentScrollPosition();
            setCurrentItemInternal(determineTargetPage(ii.position, ((((float) scrollX) / ((float) width)) - ii.offset) / ii.widthFactor, initialVelocity, (int) (this.mLastMotionX - this.mInitialMotionX)), z, z, initialVelocity);
            endDrag();
    ...
    public boolean executeKeyEvent(KeyEvent event) {
        ...
        switch (event.getKeyCode()) {
            ...
            case 61:
                ...
                if (KeyEventCompat.hasModifiers(event, i)) {
    ...
    public boolean arrowScroll(int direction) {
        ...
        if (nextFocused == null || nextFocused == currentFocused) {
            if (direction == i2 || direction == 1) {
                handled = pageLeft();
            } else if (direction == i || direction == 2) {
                handled = pageRight();
            }
