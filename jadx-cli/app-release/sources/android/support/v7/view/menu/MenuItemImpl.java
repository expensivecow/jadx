...
public final class MenuItemImpl implements SupportMenuItem {
    ...
    MenuItemImpl(MenuBuilder menuBuilder, int i, int i2, int i3, int i4, CharSequence charSequence, int i5) {
        int i6 = 4096;
        this.mShortcutNumericModifiers = i6;
        this.mShortcutAlphabeticModifiers = i6;
        boolean z = false;
        this.mIconResId = z;
        Object obj = null;
        this.mIconTintList = obj;
        this.mIconTintMode = obj;
        this.mHasIconTint = z;
        this.mHasIconTintMode = z;
    ...
    public boolean invoke() {
        ...
        return (this.mActionProvider == null || !this.mActionProvider.onPerformDefaultAction()) ? false : z;
    }
    ...
    public boolean isCheckable() {
        boolean z = true;
        return (this.mFlags & z) == z ? z : false;
    }
    ...
    void setCheckedInt(boolean z) {
        int i = this.mFlags;
        boolean z2 = false;
        this.mFlags = (z ? 2 : z2) | (this.mFlags & -3);
        if (i != this.mFlags) {
    ...
    boolean setVisibleInt(boolean z) {
        int i = this.mFlags;
        boolean z2 = false;
        this.mFlags = (z ? z2 : 8) | (this.mFlags & -9);
        return i != this.mFlags ? true : z2;
    }
    ...
    public boolean requestsActionButton() {
        boolean z = true;
        return (this.mShowAsAction & z) == z ? z : false;
    }

    public boolean requiresActionButton() {
        int i = 2;
        return (this.mShowAsAction & i) == i;
    }
