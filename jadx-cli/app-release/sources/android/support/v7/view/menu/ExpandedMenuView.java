...
public final class ExpandedMenuView extends ListView implements ItemInvoker, MenuView, OnItemClickListener {
    ...
    public ExpandedMenuView(Context context, AttributeSet attributeSet, int i) {
        ...
        int i2 = 0;
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, TINT_ATTRS, i, i2);
        if (obtainStyledAttributes.hasValue(i2)) {
            setBackgroundDrawable(obtainStyledAttributes.getDrawable(i2));
        }
        int i3 = 1;
        if (obtainStyledAttributes.hasValue(i3)) {
            setDivider(obtainStyledAttributes.getDrawable(i3));
        }
