...
final class StandardMenuPopup extends MenuPopup implements OnDismissListener, OnItemClickListener, MenuPresenter, OnKeyListener {
    ...
    private boolean tryShow() {
        ...
        this.mPopup.setModal(z);
        View view = this.mShownAnchorView;
        boolean z3 = this.mTreeObserver == null ? z : z2;
        ...
        if (!this.mHasContentWidth) {
            this.mContentWidth = MenuPopup.measureIndividualMenuWidth(this.mAdapter, viewGroup, this.mContext, this.mPopupMaxWidth);
            this.mHasContentWidth = z;
        }
        ...
        if (this.mShowTitle && this.mMenu.getHeaderTitle() != null) {
            FrameLayout frameLayout = (FrameLayout) LayoutInflater.from(this.mContext).inflate(R.layout.abc_popup_menu_header_item_layout, listView, z2);
