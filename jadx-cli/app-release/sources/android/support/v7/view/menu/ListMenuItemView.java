...
public class ListMenuItemView extends LinearLayout implements ItemView {
    ...
    public ListMenuItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        boolean z = false;
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(getContext(), attributeSet, R.styleable.MenuView, i, z);
        ...
        this.mPreserveIconSpacing = obtainStyledAttributes.getBoolean(R.styleable.MenuView_preserveIconSpacing, z);
    ...
    public void setTitle(CharSequence charSequence) {
        ...
        int i = 8;
        if (this.mTitleView.getVisibility() != i) {
    ...
    public void setCheckable(boolean z) {
        if (z || this.mRadioButton != null || this.mCheckBox != null) {
            ...
            if (z) {
                ...
                if (!(compoundButton2 == null || compoundButton2.getVisibility() == i)) {
                ...
                if (this.mRadioButton != null) {
                    this.mRadioButton.setVisibility(i);
                }
            }
        }
    }
    ...
    public void setIcon(Drawable drawable) {
        int i = 0;
        int i2 = (this.mItemData.shouldShowIcon() || this.mForceShowIcon) ? 1 : i;
        if (i2 == 0 && !this.mPreserveIconSpacing) {
            return;
        }
    ...
    private void insertIconView() {
        boolean z = false;
        this.mIconView = (ImageView) getInflater().inflate(R.layout.abc_list_menu_item_icon, this, z);
        addView(this.mIconView, z);
    }
