...
public class ActionMenuItemView extends AppCompatTextView implements ItemView, OnClickListener, ActionMenuChildView {
    ...
    public ActionMenuItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        boolean z = false;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R.styleable.ActionMenuItemView, i, z);
        this.mMinWidth = obtainStyledAttributes.getDimensionPixelSize(R.styleable.ActionMenuItemView_android_minWidth, z);
    ...
    private boolean shouldAllowTextWithIcon() {
        ...
        int i2 = 480;
        return i >= i2 || ((i >= 640 && configuration.screenHeightDp >= i2) || configuration.orientation == 2);
    }
    ...
    private void updateTextButtonVisibility() {
        int i = 1;
        int isEmpty = TextUtils.isEmpty(this.mTitle) ^ i;
        if (!(this.mIcon == null || (this.mItemData.showsTextAsAction() && (this.mAllowTextWithIcon || this.mExpandedFormat)))) {
            i = 0;
        }
        isEmpty &= i;
        CharSequence charSequence = null;
        setText(isEmpty != 0 ? this.mTitle : charSequence);
    ...
    public void setIcon(Drawable drawable) {
        ...
        setCompoundDrawables(drawable, drawable2, drawable2, drawable2);
        updateTextButtonVisibility();
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        int i3 = 1073741824;
        if (mode != i3 && this.mMinWidth > 0 && measuredWidth < i) {
            super.onMeasure(MeasureSpec.makeMeasureSpec(i, i3), i2);
        }
