...
class ActivityChooserModel extends DataSetObservable {
    ...
    public static final class ActivityResolveInfo implements Comparable<ActivityResolveInfo> {
        ...
        public boolean equals(Object obj) {
            ...
            return Float.floatToIntBits(this.weight) != Float.floatToIntBits(((ActivityResolveInfo) obj).weight) ? z2 : z;
        }
    ...
    public static final class HistoricalRecord {
        ...
        public int hashCode() {
            int i = 31;
            return (i * ((((this.activity == null ? 0 : this.activity.hashCode()) + i) * i) + ((int) (this.time ^ (this.time >>> 32))))) + Float.floatToIntBits(this.weight);
        }
        ...
        public boolean equals(Object obj) {
            ...
            return (this.time == historicalRecord.time && Float.floatToIntBits(this.weight) == Float.floatToIntBits(historicalRecord.weight)) ? z : z2;
        }
    ...
    private ActivityChooserModel(Context context, String str) {
        boolean z = true;
        this.mCanReadHistoricalData = z;
        boolean z2 = false;
        this.mReadShareHistoryCalled = z2;
        this.mHistoricalRecordsChanged = z;
        this.mReloadActivities = z2;
    ...
    public Intent chooseActivity(int i) {
        synchronized (this.mInstanceLock) {
            ...
            if (this.mActivityChoserModelPolicy != null) {
                if (this.mActivityChoserModelPolicy.onChooseActivity(this, new Intent(intent2))) {
                    return intent;
                }
            }
    ...
    private boolean loadActivitiesIfNeeded() {
        ...
        this.mReloadActivities = i;
        this.mActivities.clear();
        List queryIntentActivities = this.mContext.getPackageManager().queryIntentActivities(this.mIntent, i);
    ...
    private void pruneExcessiveHistoricalRecordsIfNeeded() {
        ...
        if (size > 0) {
            ...
            for (int i2 = i; i2 < size; i2++) {
                HistoricalRecord historicalRecord = (HistoricalRecord) this.mHistoricalRecords.remove(i);
            }
        }
    }
