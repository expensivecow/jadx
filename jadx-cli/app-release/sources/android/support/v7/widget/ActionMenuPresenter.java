...
class ActionMenuPresenter extends BaseMenuPresenter implements SubUiVisibilityListener {
        ...
        if (this.mReserveOverflow) {
            if (this.mOverflowButton == null) {
                ...
                if (this.mPendingOverflowIconSet) {
                    ...
                    this.mPendingOverflowIcon = view;
                    this.mPendingOverflowIconSet = z;
                }
                int makeMeasureSpec = MeasureSpec.makeMeasureSpec(z, z);
    ...
    public void updateMenuView(boolean z) {
        ...
        if (this.mReserveOverflow && actionItems != null) {
            ...
            i = 1;
            if (size == i) {
                i2 = ((MenuItemImpl) actionItems.get(i2)).isActionViewExpanded() ^ 1;
            } else if (size > 0) {
                i2 = i;
            }
        }
    ...
    public boolean flagActionItems() {
        ...
        while (i2 < size) {
            ...
            if (menuItemImpl2.requiresActionButton()) {
                ...
                if (measuredWidth != 0) {
                    z3 = true;
                    sparseBooleanArray.put(measuredWidth, z3);
                } else {
                    z3 = true;
                }
