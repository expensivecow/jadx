...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModelClient {
    ...
    private class ActivityChooserViewAdapter extends BaseAdapter {
            ...
            switch (getItemViewType(i)) {
                case 0:
                    if (view == null || view.getId() != R.id.list_item) {
                        view = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(R.layout.abc_activity_chooser_view_list_item, viewGroup, z);
                    }
        ...
        public int measureContentWidth() {
            ...
            int i2 = 0;
            int makeMeasureSpec = MeasureSpec.makeMeasureSpec(i2, i2);
            int makeMeasureSpec2 = MeasureSpec.makeMeasureSpec(i2, i2);
            int count = getCount();
            View view = null;
            int i3 = i2;
            View view2 = view;
            while (i2 < count) {
                view2 = getView(i2, view2, view);
        ...
        public boolean onLongClick(View view) {
            if (view == ActivityChooserView.this.mDefaultActivityButton) {
                ...
                if (ActivityChooserView.this.mAdapter.getCount() > 0) {
                    ActivityChooserView.this.mIsSelectingDefaultActivity = z;
                    ActivityChooserView.this.showPopupUnchecked(ActivityChooserView.this.mInitialActivityCount);
                }
                return z;
            }
    ...
    public ActivityChooserView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mInitialActivityCount = obtainStyledAttributes.getInt(R.styleable.ActivityChooserView_initialActivityCount, i2);
    ...
    public boolean showPopup() {
        ...
        this.mIsSelectingDefaultActivity = z;
    ...
    void showPopupUnchecked(int i) {
        ...
        boolean z = false;
        boolean z2 = true;
        boolean z3 = this.mDefaultActivityButton.getVisibility() == 0 ? z2 : z;
        int activityCount = this.mAdapter.getActivityCount();
        if (i == Integer.MAX_VALUE || activityCount <= i + z3) {
            this.mAdapter.setShowFooterView(z);
            this.mAdapter.setMaxActivityCount(i);
        } else {
            this.mAdapter.setShowFooterView(z2);
            this.mAdapter.setMaxActivityCount(i - z2);
        }
        ListPopupWindow listPopupWindow = getListPopupWindow();
        if (!listPopupWindow.isShowing()) {
            if (this.mIsSelectingDefaultActivity || !z3) {
                this.mAdapter.setShowDefaultActivity(z2, z3);
            } else {
                this.mAdapter.setShowDefaultActivity(z, z);
            }
            listPopupWindow.setContentWidth(Math.min(this.mAdapter.measureContentWidth(), this.mListPopupMaxWidth));
            listPopupWindow.show();
            if (this.mProvider != null) {
                this.mProvider.subUiVisibilityChanged(z2);
            }
            listPopupWindow.getListView().setContentDescription(getContext().getString(R.string.abc_activitychooserview_choose_application));
            listPopupWindow.getListView().setSelector(new ColorDrawable(z));
        }
    }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        i = 0;
        this.mActivityChooserContent.layout(i, i, i3 - i, i4 - i2);
        if (!isShowingPopup()) {
            dismissPopup();
        }
    }
    ...
    void updateAppearance() {
        ...
        if (this.mAdapter.getCount() > 0) {
            this.mExpandActivityOverflowButton.setEnabled(z2);
        } else {
            this.mExpandActivityOverflowButton.setEnabled(z);
        }
        boolean activityCount = this.mAdapter.getActivityCount();
        int historySize = this.mAdapter.getHistorySize();
        if (activityCount == z2 || (activityCount > z2 && historySize > 0)) {
            this.mDefaultActivityButton.setVisibility(z);
            ...
            if (this.mDefaultActionButtonContentDescription != 0) {
                ...
                int i = this.mDefaultActionButtonContentDescription;
                Object[] objArr = new Object[z2];
                objArr[z] = loadLabel;
                this.mDefaultActivityButton.setContentDescription(context.getString(i, objArr));
            }
        } else {
