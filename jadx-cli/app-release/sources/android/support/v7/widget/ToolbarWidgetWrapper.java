...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    public ToolbarWidgetWrapper(Toolbar toolbar, boolean z, int i, int i2) {
        ...
        this.mTitleSet = this.mTitle != null ? true : i2;
        this.mNavIcon = toolbar.getNavigationIcon();
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(toolbar.getContext(), null, R.styleable.ActionBar, R.attr.actionBarStyle, i2);
        ...
        if (z) {
            ...
            setDisplayOptions(obtainStyledAttributes.getInt(R.styleable.ActionBar_displayOptions, i2));
            int resourceId = obtainStyledAttributes.getResourceId(R.styleable.ActionBar_customNavigationLayout, i2);
            if (resourceId != 0) {
                setCustomView(LayoutInflater.from(this.mToolbar.getContext()).inflate(resourceId, this.mToolbar, i2));
                setDisplayOptions(this.mDisplayOpts | 16);
            }
            resourceId = obtainStyledAttributes.getLayoutDimension(R.styleable.ActionBar_height, i2);
            if (resourceId > 0) {
            ...
            int i3 = -1;
            resourceId = obtainStyledAttributes.getDimensionPixelOffset(R.styleable.ActionBar_contentInsetStart, i3);
            i3 = obtainStyledAttributes.getDimensionPixelOffset(R.styleable.ActionBar_contentInsetEnd, i3);
            if (resourceId >= 0 || i3 >= 0) {
                this.mToolbar.setContentInsetsRelative(Math.max(resourceId, i2), Math.max(i3, i2));
            }
            resourceId = obtainStyledAttributes.getResourceId(R.styleable.ActionBar_titleTextStyle, i2);
            if (resourceId != 0) {
                this.mToolbar.setTitleTextAppearance(this.mToolbar.getContext(), resourceId);
            }
            resourceId = obtainStyledAttributes.getResourceId(R.styleable.ActionBar_subtitleTextStyle, i2);
            if (resourceId != 0) {
                this.mToolbar.setSubtitleTextAppearance(this.mToolbar.getContext(), resourceId);
            }
            resourceId = obtainStyledAttributes.getResourceId(R.styleable.ActionBar_popupTheme, i2);
            if (resourceId != 0) {
    ...
    public void setNavigationMode(int i) {
        ...
        if (i != i2) {
            ...
            switch (i) {
                ...
                case 1:
                    ensureSpinner();
                    this.mToolbar.addView(this.mSpinner, i2);
                    return;
                case 2:
                    if (this.mTabView != null) {
                        this.mToolbar.addView(this.mTabView, i2);
                        Toolbar.LayoutParams layoutParams = (Toolbar.LayoutParams) this.mTabView.getLayoutParams();
                        i2 = -2;
    ...
    private void ensureSpinner() {
        if (this.mSpinner == null) {
            ...
            int i = -2;
            this.mSpinner.setLayoutParams(new Toolbar.LayoutParams(i, i, 8388627));
        }
    }
