...
public class ActionBarContextView extends AbsActionBarView {
    ...
    public ActionBarContextView(Context context, AttributeSet attributeSet, int i) {
        ...
        int i2 = 0;
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, R.styleable.ActionMode, i, i2);
        ViewCompat.setBackground(this, obtainStyledAttributes.getDrawable(R.styleable.ActionMode_background));
        this.mTitleStyleRes = obtainStyledAttributes.getResourceId(R.styleable.ActionMode_titleTextStyle, i2);
        this.mSubtitleStyleRes = obtainStyledAttributes.getResourceId(R.styleable.ActionMode_subtitleTextStyle, i2);
        this.mContentHeight = obtainStyledAttributes.getLayoutDimension(R.styleable.ActionMode_height, i2);
    ...
    private void initTitle() {
        ...
        int i = 8;
        int i2 = 0;
        this.mSubtitleView.setVisibility(isEmpty2 != 0 ? i2 : i);
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (MeasureSpec.getMode(i) != i3) {
            ...
            int makeMeasureSpec = MeasureSpec.makeMeasureSpec(i5, i6);
            int i7 = 0;
            if (this.mClose != null) {
                MarginLayoutParams marginLayoutParams = (MarginLayoutParams) this.mClose.getLayoutParams();
                paddingLeft = measureChildView(this.mClose, paddingLeft, makeMeasureSpec, i7) - (marginLayoutParams.leftMargin + marginLayoutParams.rightMargin);
            }
            if (this.mMenuView != null && this.mMenuView.getParent() == this) {
                paddingLeft = measureChildView(this.mMenuView, paddingLeft, makeMeasureSpec, i7);
            }
            if (this.mTitleLayout != null && this.mCustomView == null) {
                if (this.mTitleOptional) {
                    this.mTitleLayout.measure(MeasureSpec.makeMeasureSpec(i7, i7), makeMeasureSpec);
                    makeMeasureSpec = this.mTitleLayout.getMeasuredWidth();
                    i4 = makeMeasureSpec <= paddingLeft ? 1 : i7;
                    if (i4 != 0) {
                        paddingLeft -= makeMeasureSpec;
                    }
                    this.mTitleLayout.setVisibility(i4 != 0 ? i7 : 8);
                } else {
                    paddingLeft = measureChildView(this.mTitleLayout, paddingLeft, makeMeasureSpec, i7);
                }
            }
            if (this.mCustomView != null) {
                LayoutParams layoutParams = this.mCustomView.getLayoutParams();
                int i8 = -2;
                i4 = layoutParams.width != i8 ? i3 : i6;
            ...
            if (this.mContentHeight <= 0) {
                ...
                i3 = i7;
                while (i7 < i2) {
                    paddingLeft = getChildAt(i7).getMeasuredHeight() + paddingTop;
                    if (paddingLeft > i3) {
                        i3 = paddingLeft;
                    }
                    i7++;
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        int i5 = 8;
        if (this.mClose == null || this.mClose.getVisibility() == i5) {
            i4 = paddingRight;
        } else {
            MarginLayoutParams marginLayoutParams = (MarginLayoutParams) this.mClose.getLayoutParams();
            int i6 = z ? marginLayoutParams.rightMargin : marginLayoutParams.leftMargin;
            i4 = z ? marginLayoutParams.leftMargin : marginLayoutParams.rightMargin;
            int next = AbsActionBarView.next(paddingRight, i6, z);
            i4 = AbsActionBarView.next(next + positionChild(this.mClose, next, paddingTop, i2, z), i4, z);
        }
        if (!(this.mTitleLayout == null || this.mCustomView != null || this.mTitleLayout.getVisibility() == i5)) {
            i4 += positionChild(this.mTitleLayout, i4, paddingTop, i2, z);
        }
        int i7 = i4;
        if (this.mCustomView != null) {
            positionChild(this.mCustomView, i7, paddingTop, i2, z);
        }
