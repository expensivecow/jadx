...
public class SwitchCompat extends CompoundButton {
    ...
    public SwitchCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        Mode mode = null;
        this.mThumbTintList = mode;
        this.mThumbTintMode = mode;
        boolean z = false;
        this.mHasThumbTint = z;
        this.mHasThumbTintMode = z;
        this.mTrackTintList = mode;
        this.mTrackTintMode = mode;
        this.mHasTrackTint = z;
        this.mHasTrackTintMode = z;
        this.mVelocityTracker = VelocityTracker.obtain();
        this.mTempRect = new Rect();
        boolean z2 = true;
        this.mTextPaint = new TextPaint(z2);
        Resources resources = getResources();
        this.mTextPaint.density = resources.getDisplayMetrics().density;
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, R.styleable.SwitchCompat, i, z);
        ...
        this.mShowText = obtainStyledAttributes.getBoolean(R.styleable.SwitchCompat_showText, z2);
        this.mThumbTextPadding = obtainStyledAttributes.getDimensionPixelSize(R.styleable.SwitchCompat_thumbTextPadding, z);
        this.mSwitchMinWidth = obtainStyledAttributes.getDimensionPixelSize(R.styleable.SwitchCompat_switchMinWidth, z);
        this.mSwitchPadding = obtainStyledAttributes.getDimensionPixelSize(R.styleable.SwitchCompat_switchPadding, z);
        this.mSplitTrack = obtainStyledAttributes.getBoolean(R.styleable.SwitchCompat_splitTrack, z);
        ColorStateList colorStateList = obtainStyledAttributes.getColorStateList(R.styleable.SwitchCompat_thumbTint);
        if (colorStateList != null) {
            this.mThumbTintList = colorStateList;
            this.mHasThumbTint = z2;
        }
        int i2 = -1;
        Mode parseTintMode = DrawableUtils.parseTintMode(obtainStyledAttributes.getInt(R.styleable.SwitchCompat_thumbTintMode, i2), mode);
        if (this.mThumbTintMode != parseTintMode) {
            this.mThumbTintMode = parseTintMode;
            this.mHasThumbTintMode = z2;
        }
        ...
        if (colorStateList != null) {
            ...
            this.mHasTrackTint = z2;
        }
        parseTintMode = DrawableUtils.parseTintMode(obtainStyledAttributes.getInt(R.styleable.SwitchCompat_trackTintMode, i2), mode);
        if (this.mTrackTintMode != parseTintMode) {
            this.mTrackTintMode = parseTintMode;
            this.mHasTrackTintMode = z2;
        }
        if (this.mHasTrackTint || this.mHasTrackTintMode) {
            applyTrackTint();
        }
        i = obtainStyledAttributes.getResourceId(R.styleable.SwitchCompat_switchTextAppearance, z);
        if (i != 0) {
    ...
    public void setSwitchTextAppearance(Context context, int i) {
        ...
        boolean z = false;
        i = obtainStyledAttributes.getDimensionPixelSize(R.styleable.TextAppearance_android_textSize, z);
        if (i != 0) {
            float f = (float) i;
        ...
        int i2 = -1;
        setSwitchTypefaceByIndex(obtainStyledAttributes.getInt(R.styleable.TextAppearance_android_typeface, i2), obtainStyledAttributes.getInt(R.styleable.TextAppearance_android_textStyle, i2));
        if (obtainStyledAttributes.getBoolean(R.styleable.TextAppearance_textAllCaps, z)) {
    ...
    public void setSwitchTypeface(Typeface typeface, int i) {
        ...
        if (i > 0) {
            ...
            int style = ((typeface != null ? typeface.getStyle() : z) ^ -1) & i;
    ...
    public void onMeasure(int i, int i2) {
        ...
        int i4 = 2;
        this.mThumbWidth = Math.max(this.mShowText ? Math.max(this.mOnLayout.getWidth(), this.mOffLayout.getWidth()) + (this.mThumbTextPadding * i4) : i3, intrinsicWidth);
        if (this.mTrackDrawable != null) {
        ...
        i5 = Math.max(this.mSwitchMinWidth, ((i4 * this.mThumbWidth) + intrinsicWidth) + i5);
            ...
            case 2:
                ...
                switch (this.mTouchMode) {
                    ...
                    case 2:
                        ...
                        y2 = 1.0f;
                        float f = 0.0f;
                        y = thumbScrollRange != 0 ? y / ((float) thumbScrollRange) : y > f ? y2 : -1.0f;
                        if (ViewUtils.isLayoutRtl(this)) {
                            y = -y;
                        }
                        x = constrain(this.mThumbPosition + y, f, y2);
    ...
    private void stopDrag(MotionEvent motionEvent) {
        ...
        this.mTouchMode = z2;
        boolean z3 = true;
        int i = (motionEvent.getAction() == z3 && isEnabled()) ? z3 : z2;
        ...
        if (i != 0) {
            ...
            if (Math.abs(xVelocity) > ((float) this.mMinFlingVelocity)) {
                float f = 0.0f;
                if (ViewUtils.isLayoutRtl(this) ? xVelocity >= f : xVelocity <= f) {
                    z3 = z2;
                }
                z = z3;
            } else {
    ...
    private void animateThumbToCheckedState(boolean z) {
        ...
        if (VERSION.SDK_INT >= 18) {
            this.mPositionAnimator.setAutoCancel(z2);
        }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.mThumbDrawable != null) {
            ...
            Rect opticalBounds = DrawableUtils.getOpticalBounds(this.mThumbDrawable);
            i3 = Math.max(i, opticalBounds.left - rect.left);
            max = Math.max(i, opticalBounds.right - rect.right);
            i = i3;
        } else {
            max = i;
        }
