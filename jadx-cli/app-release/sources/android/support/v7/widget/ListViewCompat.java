...
public class ListViewCompat extends ListView {
    ...
    public ListViewCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        int i2 = 0;
        this.mSelectionLeftPadding = i2;
        this.mSelectionTopPadding = i2;
        this.mSelectionRightPadding = i2;
        this.mSelectionBottomPadding = i2;
        try {
    ...
    protected void positionSelectorLikeFocusCompat(int i, View view) {
        ...
        boolean z = true;
        boolean z2 = false;
        boolean z3 = (selector == null || i == -1) ? z2 : z;
        if (z3) {
            selector.setVisible(z2, z2);
        }
    ...
    public int measureHeightOfChildrenCompat(int i, int i2, int i3, int i4, int i5) {
        ...
        while (i2 < count) {
            ...
            view2 = adapter.getView(i2, view2, this);
            ...
            if (layoutParams.height > 0) {
                ...
                itemViewType = MeasureSpec.makeMeasureSpec(i3, i3);
            }
            view2.measure(i, itemViewType);
            view2.forceLayout();
            if (i2 > 0) {
                i6 += dividerHeight;
            }
