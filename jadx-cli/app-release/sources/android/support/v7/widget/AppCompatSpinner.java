...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    private class DropdownPopup extends ListPopupWindow {
        ...
        void computeContentWidth() {
            ...
            if (background != null) {
                ...
                AppCompatSpinner.this.mTempRect.right = i2;
                access$100.left = i2;
            }
    ...
    int compatMeasureContentWidth(SpinnerAdapter spinnerAdapter, Drawable drawable) {
        ...
        int makeMeasureSpec = MeasureSpec.makeMeasureSpec(getMeasuredWidth(), i);
        int makeMeasureSpec2 = MeasureSpec.makeMeasureSpec(getMeasuredHeight(), i);
        int max = Math.max(i, getSelectedItemPosition());
        int min = Math.min(spinnerAdapter.getCount(), max + 15);
        View view = null;
        int i2 = i;
        View view2 = view;
        for (max = Math.max(i, max - (15 - (min - max))); max < min; max++) {
            int itemViewType = spinnerAdapter.getItemViewType(max);
            if (itemViewType != i) {
                view2 = view;
                i = itemViewType;
            }
            view2 = spinnerAdapter.getView(max, view2, this);
            if (view2.getLayoutParams() == null) {
                int i3 = -2;
                view2.setLayoutParams(new LayoutParams(i3, i3));
            }
