...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    ...
    private void init(Context context) {
        ...
        boolean z = false;
        this.mActionBarHeight = obtainStyledAttributes.getDimensionPixelSize(z, z);
        boolean z2 = true;
        this.mWindowContentOverlay = obtainStyledAttributes.getDrawable(z2);
        setWillNotDraw(this.mWindowContentOverlay == null ? z2 : z);
    ...
    protected void onMeasure(int i, int i2) {
        ...
        int i4 = 0;
        int max = Math.max(i4, (this.mActionBarTop.getMeasuredWidth() + layoutParams.leftMargin) + layoutParams.rightMargin);
        int max2 = Math.max(i4, (this.mActionBarTop.getMeasuredHeight() + layoutParams.topMargin) + layoutParams.bottomMargin);
        int combineMeasuredStates = View.combineMeasuredStates(i4, this.mActionBarTop.getMeasuredState());
        int i5 = (ViewCompat.getWindowSystemUiVisibility(this) & 256) != 0 ? 1 : i4;
        if (i5 != 0) {
            ...
            i3 = this.mActionBarTop.getVisibility() != 8 ? this.mActionBarTop.getMeasuredHeight() : i4;
        }
        this.mContentInsets.set(this.mBaseContentInsets);
        this.mInnerInsets.set(this.mBaseInnerInsets);
        Rect rect;
        if (this.mOverlayMode || i5 != 0) {
        ...
        i4 = View.combineMeasuredStates(combineMeasuredStates, this.mContent.getMeasuredState());
        setMeasuredDimension(View.resolveSizeAndState(Math.max(max + (getPaddingLeft() + getPaddingRight()), getSuggestedMinimumWidth()), i, i4), View.resolveSizeAndState(Math.max(max2 + (getPaddingTop() + getPaddingBottom()), getSuggestedMinimumHeight()), i2, i4 << 16));
    }
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.mWindowContentOverlay != null && !this.mIgnoreWindowContentOverlay) {
            int i = 0;
            int bottom = this.mActionBarTop.getVisibility() == 0 ? (int) ((((float) this.mActionBarTop.getBottom()) + this.mActionBarTop.getTranslationY()) + 0.5f) : i;
            this.mWindowContentOverlay.setBounds(i, bottom, getWidth(), this.mWindowContentOverlay.getIntrinsicHeight() + bottom);
