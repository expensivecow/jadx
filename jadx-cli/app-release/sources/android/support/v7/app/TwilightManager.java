...
class TwilightManager {
    ...
    private Location getLastKnownLocation() {
        ...
        Location lastKnownLocationForProvider = PermissionChecker.checkSelfPermission(this.mContext, "android.permission.ACCESS_COARSE_LOCATION") == 0 ? getLastKnownLocationForProvider("network") : location;
    ...
    private void updateState(@NonNull Location location) {
        ...
        twilightCalculator.calculateTwilight(currentTimeMillis - j, location.getLatitude(), location.getLongitude());
        ...
        long j5 = j3;
        boolean z3 = z2;
        instance.calculateTwilight(currentTimeMillis + j, location.getLatitude(), location.getLongitude());
        ...
        if (j5 == j8 || j2 == j8) {
            ...
            j8 = currentTimeMillis > j2 ? j7 + j6 : currentTimeMillis > j5 ? j7 + j2 : j7 + j5;
            j8 += 60000;
        }
