...
class AppCompatViewInflater {
    ...
    private View createViewFromTag(Context context, String str, AttributeSet attributeSet) {
        Object obj = null;
        if (str.equals("view")) {
            str = attributeSet.getAttributeValue(obj, "class");
        }
        int i = 1;
        int i2 = 0;
        try {
            this.mConstructorArgs[i2] = context;
            this.mConstructorArgs[i] = attributeSet;
            if (-1 == str.indexOf(46)) {
                for (int i3 = i2; i3 < sClassPrefixList.length; i3++) {
                    View createView = createView(context, str, sClassPrefixList[i3]);
                    if (createView != null) {
                        this.mConstructorArgs[i2] = obj;
                        this.mConstructorArgs[i] = obj;
                        return createView;
                    }
                }
                this.mConstructorArgs[i2] = obj;
            ...
            View createView2 = createView(context, str, obj);
            this.mConstructorArgs[i2] = obj;
            this.mConstructorArgs[i] = obj;
            return createView2;
    ...
    private static Context themifyContext(Context context, AttributeSet attributeSet, boolean z, boolean z2) {
        int i = 0;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R.styleable.View, i, i);
        int resourceId = z ? obtainStyledAttributes.getResourceId(R.styleable.View_android_theme, i) : i;
        if (z2 && resourceId == 0) {
            resourceId = obtainStyledAttributes.getResourceId(R.styleable.View_theme, i);
            if (resourceId != 0) {
