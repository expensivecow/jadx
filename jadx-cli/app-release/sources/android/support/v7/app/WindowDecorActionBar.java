...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    public class ActionModeImpl extends ActionMode implements MenuBuilder.Callback {
        ...
        public void finish() {
            if (WindowDecorActionBar.this.mActionMode == this) {
                boolean z = false;
                if (WindowDecorActionBar.checkShowingFlags(WindowDecorActionBar.this.mHiddenByApp, WindowDecorActionBar.this.mHiddenBySystem, z)) {
                ...
                Object obj = null;
                this.mCallback = obj;
                WindowDecorActionBar.this.animateToMode(z);
                WindowDecorActionBar.this.mContextView.closeMode();
                WindowDecorActionBar.this.mDecorToolbar.getViewGroup().sendAccessibilityEvent(32);
                WindowDecorActionBar.this.mOverlayLayout.setHideOnContentScrollEnabled(WindowDecorActionBar.this.mHideOnContentScroll);
                WindowDecorActionBar.this.mActionMode = obj;
            }
        }
        ...
        this.mHideListener = new ViewPropertyAnimatorListenerAdapter() {
            public void onAnimationEnd(View view) {
                if (WindowDecorActionBar.this.mContentAnimations && WindowDecorActionBar.this.mContentView != null) {
                    float f = 0.0f;
                    WindowDecorActionBar.this.mContentView.setTranslationY(f);
                    WindowDecorActionBar.this.mContainerView.setTranslationY(f);
                }
    ...
    private void init(View view) {
        ...
        boolean z = true;
        boolean z2 = false;
        boolean z3 = (this.mDecorToolbar.getDisplayOptions() & 4) != 0 ? z : z2;
        if (z3) {
            this.mDisplayHomeAsUpSet = z;
        }
        ActionBarPolicy actionBarPolicy = ActionBarPolicy.get(this.mContext);
        z3 = (actionBarPolicy.enableHomeButtonByDefault() || z3) ? z : z2;
        setHomeButtonEnabled(z3);
        setHasEmbeddedTabs(actionBarPolicy.hasEmbeddedTabs());
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(null, R.styleable.ActionBar, R.attr.actionBarStyle, z2);
        if (obtainStyledAttributes.getBoolean(R.styleable.ActionBar_hideOnContentScroll, z2)) {
            setHideOnContentScrollEnabled(z);
        }
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(R.styleable.ActionBar_elevation, z2);
    ...
    private void setHasEmbeddedTabs(boolean z) {
        ...
        boolean z2 = true;
        boolean z3 = false;
        z = getNavigationMode() == 2 ? z2 : z3;
        if (this.mTabScrollView != null) {
            if (z) {
                this.mTabScrollView.setVisibility(z3);
                if (this.mOverlayLayout != null) {
        ...
        boolean z4 = (this.mHasEmbeddedTabs || !z) ? z3 : z2;
    ...
    void completeDeferredDestroyActionMode() {
        if (this.mDeferredModeDestroyCallback != null) {
            ...
            Object obj = null;
            this.mDeferredDestroyActionMode = obj;
            this.mDeferredModeDestroyCallback = obj;
        }
    }
    ...
    private void showForActionMode() {
        if (!this.mShowingForMode) {
            boolean z = true;
            this.mShowingForMode = z;
            if (this.mOverlayLayout != null) {
                this.mOverlayLayout.setShowingForActionMode(z);
            }
    ...
    public void doHide(boolean z) {
        ...
        if (this.mCurWindowVisibility == 0 && (this.mShowHideAnimationEnabled || z)) {
            this.mContainerView.setAlpha(1.0f);
            boolean z2 = true;
            this.mContainerView.setTransitioning(z2);
            ViewPropertyAnimatorCompatSet viewPropertyAnimatorCompatSet = new ViewPropertyAnimatorCompatSet();
    ...
    public void animateToMode(boolean z) {
        ...
        if (shouldAnimateContextView()) {
            ...
            long j2 = 100;
            if (z) {
                viewPropertyAnimatorCompat = this.mDecorToolbar.setupAnimatorToVisibility(i2, j2);
                viewPropertyAnimatorCompat2 = this.mContextView.setupAnimatorToVisibility(i3, j);
            } else {
                viewPropertyAnimatorCompat2 = this.mDecorToolbar.setupAnimatorToVisibility(i3, j);
                viewPropertyAnimatorCompat = this.mContextView.setupAnimatorToVisibility(i, j2);
            }
            ViewPropertyAnimatorCompatSet viewPropertyAnimatorCompatSet = new ViewPropertyAnimatorCompatSet();
            viewPropertyAnimatorCompatSet.playSequentially(viewPropertyAnimatorCompat, viewPropertyAnimatorCompat2);
            viewPropertyAnimatorCompatSet.start();
        } else if (z) {
            this.mDecorToolbar.setVisibility(i2);
            this.mContextView.setVisibility(i3);
        } else {
    ...
    public void setNavigationMode(int i) {
        ...
        if (i == i2) {
            ensureTabsExist();
            this.mTabScrollView.setVisibility(z);
            int i3 = -1;
            if (this.mSavedTabPosition != i3) {
        ...
        DecorToolbar decorToolbar = this.mDecorToolbar;
        boolean z2 = true;
        boolean z3 = (i != i2 || this.mHasEmbeddedTabs) ? z : z2;
        decorToolbar.setCollapsible(z3);
        ActionBarOverlayLayout actionBarOverlayLayout = this.mOverlayLayout;
        if (i == i2 && !this.mHasEmbeddedTabs) {
            z = z2;
        }
    ...
    public boolean onKeyShortcut(int i, KeyEvent keyEvent) {
        ...
        boolean z2 = true;
        if (KeyCharacterMap.load(keyEvent != null ? keyEvent.getDeviceId() : -1).getKeyboardType() == z2) {
            z2 = z;
        }
        menu.setQwertyMode(z2);
        return menu.performShortcut(i, keyEvent, z);
    }
}
