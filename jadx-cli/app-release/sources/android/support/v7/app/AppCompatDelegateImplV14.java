...
class AppCompatDelegateImplV14 extends AppCompatDelegateImplV11 {
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (bundle != null) {
            ...
            if (this.mLocalNightMode == i) {
                this.mLocalNightMode = bundle.getInt("appcompat:local_night_mode", i);
            }
        }
    }
    ...
    private boolean shouldRecreateOnNightModeChange() {
        ...
        boolean z2 = true;
        try {
            if ((this.mContext.getPackageManager().getActivityInfo(new ComponentName(this.mContext, this.mContext.getClass()), z).configChanges & 512) == 0) {
                z = z2;
            }
            return z;
        } catch (Throwable e) {
