...
class ToolbarActionBar extends ActionBar {
        ...
        public void onMenuModeChange(MenuBuilder menuBuilder) {
            if (ToolbarActionBar.this.mWindowCallback != null) {
                ...
                if (ToolbarActionBar.this.mDecorToolbar.isOverflowMenuShowing()) {
                    ToolbarActionBar.this.mWindowCallback.onPanelClosed(i, menuBuilder);
                } else if (ToolbarActionBar.this.mWindowCallback.onPreparePanel(0, null, menuBuilder)) {
                    ToolbarActionBar.this.mWindowCallback.onMenuOpened(i, menuBuilder);
                }
            }
        }
    }
    ...
    public void setCustomView(View view) {
        int i = -2;
        setCustomView(view, new LayoutParams(i, i));
    }
    ...
    void populateOptionsMenu() {
        Menu menu = getMenu();
        View view = null;
        MenuBuilder menuBuilder = menu instanceof MenuBuilder ? (MenuBuilder) menu : view;
        if (menuBuilder != null) {
        ...
        try {
            menu.clear();
            int i = 0;
            if (!(this.mWindowCallback.onCreatePanelMenu(i, menu) && this.mWindowCallback.onPreparePanel(i, view, menu))) {
                menu.clear();
            }
            if (menuBuilder != null) {
