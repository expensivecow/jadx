...
public final class BidiFormatter {
    ...
    static {
        int i = 2;
        DEFAULT_LTR_INSTANCE = new BidiFormatter(false, i, DEFAULT_TEXT_DIRECTION_HEURISTIC);
        DEFAULT_RTL_INSTANCE = new BidiFormatter(true, i, DEFAULT_TEXT_DIRECTION_HEURISTIC);
    }
    ...
    private static boolean isRtlLocale(Locale locale) {
        boolean z = true;
        return TextUtilsCompat.getLayoutDirectionFromLocale(locale) == z ? z : false;
    }
