...
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Exception block dominator not found, method:android.support.v4.widget.PopupWindowCompat.PopupWindowCompatBaseImpl.setWindowLayoutType(android.widget.PopupWindow, int):void, dom blocks: []
...
*/
        ...
        public int getWindowLayoutType(PopupWindow popupWindow) {
            ...
            if (!sGetWindowLayoutTypeMethodAttempted) {
                boolean z = true;
                try {
                    sGetWindowLayoutTypeMethod = PopupWindow.class.getDeclaredMethod("getWindowLayoutType", new Class[i]);
                    sGetWindowLayoutTypeMethod.setAccessible(z);
            ...
            if (sGetWindowLayoutTypeMethod != null) {
                try {
                    return ((Integer) sGetWindowLayoutTypeMethod.invoke(popupWindow, new Object[i])).intValue();
