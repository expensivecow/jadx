...
public final class TextViewCompat {
    ...
    static class TextViewCompatBaseImpl {
        ...
        public int getMaxLines(TextView textView) {
            ...
            if (!sMaxModeFieldFetched) {
                ...
                sMaxModeFieldFetched = z;
            }
            if (sMaxModeField != null && retrieveIntFromField(sMaxModeField, textView) == z) {
                if (!sMaximumFieldFetched) {
                    sMaximumField = retrieveField("mMaximum");
                    sMaximumFieldFetched = z;
                }
        ...
        public int getMinLines(TextView textView) {
            ...
            if (!sMinModeFieldFetched) {
                ...
                sMinModeFieldFetched = z;
            }
            if (sMinModeField != null && retrieveIntFromField(sMinModeField, textView) == z) {
                if (!sMinimumFieldFetched) {
                    sMinimumField = retrieveField("mMinimum");
                    sMinimumFieldFetched = z;
                }
    ...
    static class TextViewCompatApi17Impl extends TextViewCompatApi16Impl {
        ...
        public void setCompoundDrawablesRelative(@NonNull TextView textView, @Nullable Drawable drawable, @Nullable Drawable drawable2, @Nullable Drawable drawable3, @Nullable Drawable drawable4) {
            ...
            Drawable drawable5 = i != 0 ? drawable3 : drawable;
            if (i == 0) {
                drawable = drawable3;
            }
        ...
        public Drawable[] getCompoundDrawablesRelative(@NonNull TextView textView) {
            ...
            if (i != 0) {
                ...
                compoundDrawables[i3] = drawable2;
            }
