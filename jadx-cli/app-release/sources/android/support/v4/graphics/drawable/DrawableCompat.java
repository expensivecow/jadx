    ...
    static class DrawableCompatApi17Impl extends DrawableCompatBaseImpl {
        ...
        public boolean setLayoutDirection(Drawable drawable, int i) {
            ...
            if (!sSetLayoutDirectionMethodFetched) {
                try {
                    ...
                    sSetLayoutDirectionMethod = Drawable.class.getDeclaredMethod("setLayoutDirection", clsArr);
                    sSetLayoutDirectionMethod.setAccessible(z2);
                } catch (Throwable e) {
                    Log.i("DrawableCompatApi17", "Failed to retrieve setLayoutDirection(int) method", e);
                }
                sSetLayoutDirectionMethodFetched = z2;
            }
        ...
        public int getLayoutDirection(Drawable drawable) {
            ...
            if (!sGetLayoutDirectionMethodFetched) {
                boolean z = true;
                try {
                    sGetLayoutDirectionMethod = Drawable.class.getDeclaredMethod("getLayoutDirection", new Class[i]);
                    sGetLayoutDirectionMethod.setAccessible(z);
                } catch (Throwable e) {
            ...
            if (sGetLayoutDirectionMethod != null) {
                try {
                    return ((Integer) sGetLayoutDirectionMethod.invoke(drawable, new Object[i])).intValue();
                } catch (Throwable e2) {
