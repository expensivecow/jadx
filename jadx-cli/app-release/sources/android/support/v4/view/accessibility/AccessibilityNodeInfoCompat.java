...
public class AccessibilityNodeInfoCompat {
    ...
    public static class AccessibilityActionCompat {
        ...
        static {
            ...
            ACTION_FOCUS = new AccessibilityActionCompat(1, charSequence);
            ACTION_CLEAR_FOCUS = new AccessibilityActionCompat(2, charSequence);
            ACTION_SELECT = new AccessibilityActionCompat(4, charSequence);
            ACTION_CLEAR_SELECTION = new AccessibilityActionCompat(8, charSequence);
            ACTION_CLICK = new AccessibilityActionCompat(16, charSequence);
            ACTION_LONG_CLICK = new AccessibilityActionCompat(32, charSequence);
            ACTION_ACCESSIBILITY_FOCUS = new AccessibilityActionCompat(64, charSequence);
            ACTION_CLEAR_ACCESSIBILITY_FOCUS = new AccessibilityActionCompat(128, charSequence);
            ACTION_NEXT_AT_MOVEMENT_GRANULARITY = new AccessibilityActionCompat(256, charSequence);
            ACTION_PREVIOUS_AT_MOVEMENT_GRANULARITY = new AccessibilityActionCompat(512, charSequence);
            ACTION_NEXT_HTML_ELEMENT = new AccessibilityActionCompat(1024, charSequence);
            ACTION_PREVIOUS_HTML_ELEMENT = new AccessibilityActionCompat(2048, charSequence);
            ACTION_SCROLL_FORWARD = new AccessibilityActionCompat(4096, charSequence);
            ACTION_SCROLL_BACKWARD = new AccessibilityActionCompat(8192, charSequence);
            ACTION_COPY = new AccessibilityActionCompat(16384, charSequence);
            ACTION_PASTE = new AccessibilityActionCompat(32768, charSequence);
            ACTION_CUT = new AccessibilityActionCompat(65536, charSequence);
            ACTION_SET_SELECTION = new AccessibilityActionCompat(131072, charSequence);
            ACTION_EXPAND = new AccessibilityActionCompat(262144, charSequence);
            ACTION_COLLAPSE = new AccessibilityActionCompat(524288, charSequence);
            ACTION_DISMISS = new AccessibilityActionCompat(1048576, charSequence);
            ACTION_SET_TEXT = new AccessibilityActionCompat(2097152, charSequence);
        }
