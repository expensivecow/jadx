...
public class PagerTabStrip extends PagerTitleStrip {
    ...
    public PagerTabStrip(Context context, AttributeSet attributeSet) {
        ...
        this.mDrawFullUnderlineSet = z;
        this.mIndicatorColor = this.mTextColor;
        this.mTabPaint.setColor(this.mIndicatorColor);
        float f = context.getResources().getDisplayMetrics().density;
        float f2 = 0.5f;
        this.mIndicatorHeight = (int) ((3.0f * f) + f2);
        this.mMinPaddingBottom = (int) ((6.0f * f) + f2);
        this.mMinTextSpacing = (int) (64.0f * f);
        this.mTabPadding = (int) ((16.0f * f) + f2);
        this.mFullUnderlineHeight = (int) ((1.0f * f) + f2);
        this.mMinStripHeight = (int) ((32.0f * f) + f2);
        this.mTouchSlop = ViewConfiguration.get(context).getScaledTouchSlop();
        setPadding(getPaddingLeft(), getPaddingTop(), getPaddingRight(), getPaddingBottom());
        setTextSpacing(getTextSpacing());
        setWillNotDraw(z);
        z = true;
        this.mPrevText.setFocusable(z);
            ...
            case 1:
                if (x >= ((float) (this.mCurrText.getLeft() - this.mTabPadding))) {
                    if (x > ((float) (this.mCurrText.getRight() + this.mTabPadding))) {
                        this.mPager.setCurrentItem(this.mPager.getCurrentItem() + z2);
                        break;
                    }
                }
                this.mPager.setCurrentItem(this.mPager.getCurrentItem() - z2);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int i2 = 16777215;
        this.mTabPaint.setColor((this.mTabAlpha << 24) | (this.mIndicatorColor & i2));
        float f = (float) height;
        canvas.drawRect((float) left, (float) i, (float) right, f, this.mTabPaint);
        if (this.mDrawFullUnderline) {
            this.mTabPaint.setColor(-16777216 | (this.mIndicatorColor & i2));
