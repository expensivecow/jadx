...
public class ViewCompat {
    ...
    static class ViewCompatBaseImpl {
        ...
        public boolean hasAccessibilityDelegate(View view) {
            ...
            if (sAccessibilityDelegateField == null) {
                try {
                    ...
                    sAccessibilityDelegateField.setAccessible(z2);
                } catch (Throwable unused) {
                    sAccessibilityDelegateCheckFailed = z2;
                    return z;
                }
            }
            try {
        ...
        private void bindTempDetach() {
            try {
                int i = 0;
                this.mDispatchStartTemporaryDetach = View.class.getDeclaredMethod("dispatchStartTemporaryDetach", new Class[i]);
                this.mDispatchFinishTemporaryDetach = View.class.getDeclaredMethod("dispatchFinishTemporaryDetach", new Class[i]);
            } catch (Throwable e) {
        ...
        public int getMinimumWidth(View view) {
            if (!sMinWidthFieldFetched) {
                ...
                try {
                    ...
                    sMinWidthField.setAccessible(z);
                } catch (NoSuchFieldException unused) {
                    sMinWidthFieldFetched = z;
                }
            }
        ...
        public int getMinimumHeight(View view) {
            if (!sMinHeightFieldFetched) {
                ...
                try {
                    ...
                    sMinHeightField.setAccessible(z);
                } catch (NoSuchFieldException unused) {
                    sMinHeightFieldFetched = z;
                }
            }
