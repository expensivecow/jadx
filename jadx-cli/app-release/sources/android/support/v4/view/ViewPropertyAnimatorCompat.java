    ...
    static class ViewPropertyAnimatorListenerApi14 implements ViewPropertyAnimatorListener {
        ...
        public void onAnimationStart(View view) {
            ...
            if (this.mVpa.mOldLayerType > -1) {
                view.setLayerType(2, viewPropertyAnimatorListener);
            }
            if (this.mVpa.mStartAction != null) {
                Runnable runnable = this.mVpa.mStartAction;
                this.mVpa.mStartAction = viewPropertyAnimatorListener;
                runnable.run();
            }
        ...
        public void onAnimationEnd(View view) {
            int i = -1;
            ViewPropertyAnimatorListener viewPropertyAnimatorListener = null;
            if (this.mVpa.mOldLayerType > i) {
                view.setLayerType(this.mVpa.mOldLayerType, viewPropertyAnimatorListener);
                this.mVpa.mOldLayerType = i;
            }
            if (VERSION.SDK_INT >= 16 || !this.mAnimEndCalled) {
                if (this.mVpa.mEndAction != null) {
                    Runnable runnable = this.mVpa.mEndAction;
                    this.mVpa.mEndAction = viewPropertyAnimatorListener;
                    runnable.run();
                }
                Object tag = view.getTag(2113929216);
                if (tag instanceof ViewPropertyAnimatorListener) {
