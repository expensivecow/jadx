...
public final class MediaBrowserCompat {
        ...
        public void handleMessage(Message message) {
            if (this.mCallbacksMessengerRef != null && this.mCallbacksMessengerRef.get() != null && this.mCallbackImplRef.get() != null) {
                ...
                try {
                    switch (message.what) {
                        case 1:
                            mediaBrowserServiceCallbackImpl.onServiceConnected(messenger, data.getString("data_media_item_id"), (Token) data.getParcelable("data_media_session_token"), data.getBundle("data_root_hints"));
                            break;
                        case 2:
    ...
    public static abstract class SubscriptionCallback {
        ...
        public SubscriptionCallback() {
            ...
            if (VERSION.SDK_INT >= 26) {
                ...
                this.mSubscriptionCallbackObj = iBinder;
                this.mToken = new Binder();
            }
        }
    ...
    static class MediaBrowserImplApi21 implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl, ConnectionCallbackInternal {
        ...
        public void search(@NonNull final String str, final Bundle bundle, @NonNull final SearchCallback searchCallback) {
            if (!isConnected()) {
                ...
                try {
                    ...
                    stringBuilder.append(str);
                    Log.i("MediaBrowserCompat", stringBuilder.toString(), e);
                    this.mHandler.post(new Runnable() {
                        public void run() {
                            searchCallback.onError(str, bundle);
                        }
        ...
        public void onConnectionSuspended() {
            ...
            this.mCallbacksMessenger = obj;
            this.mMediaSessionToken = obj;
            this.mHandler.setCallbacksMessenger(obj);
        }
    ...
    static class MediaBrowserImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        private class MediaServiceConnection implements ServiceConnection {
                ...
                postOrRun(new Runnable() {
                    public void run() {
                        ...
                        if (MediaServiceConnection.this.isCurrent("onServiceDisconnected")) {
                            ...
                            MediaBrowserImplBase.this.mServiceBinderWrapper = messenger;
                            MediaBrowserImplBase.this.mCallbacksMessenger = messenger;
                            MediaBrowserImplBase.this.mHandler.setCallbacksMessenger(messenger);
            ...
            boolean isCurrent(String str) {
                boolean z = true;
                if (MediaBrowserImplBase.this.mServiceConnection == this && MediaBrowserImplBase.this.mState != 0 && MediaBrowserImplBase.this.mState != z) {
                    return z;
                }
                if (!(MediaBrowserImplBase.this.mState == 0 || MediaBrowserImplBase.this.mState == z)) {
                    StringBuilder stringBuilder = new StringBuilder();
                    stringBuilder.append(str);
        ...
        void forceCloseConnection() {
            ...
            this.mState = 1;
            Token token = null;
            this.mServiceConnection = token;
            this.mServiceBinderWrapper = token;
            this.mCallbacksMessenger = token;
            this.mHandler.setCallbacksMessenger(token);
            this.mRootId = token;
        ...
        private boolean isCurrent(Messenger messenger, String str) {
            boolean z = true;
            if (this.mCallbacksMessenger == messenger && this.mState != 0 && this.mState != z) {
                return z;
            }
            if (!(this.mState == 0 || this.mState == z)) {
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append(str);
                stringBuilder.append(" for ");
                stringBuilder.append(this.mServiceComponent);
