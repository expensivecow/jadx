...
class MediaBrowserServiceCompatApi21 {
    ...
    static class MediaBrowserServiceAdaptor extends MediaBrowserService {
        ...
        public android.service.media.MediaBrowserService.BrowserRoot onGetRoot(String str, int i, Bundle bundle) {
            android.service.media.MediaBrowserService.BrowserRoot browserRoot = null;
            BrowserRoot onGetRoot = this.mServiceProxy.onGetRoot(str, i, bundle == null ? browserRoot : new Bundle(bundle));
            return onGetRoot == null ? browserRoot : new android.service.media.MediaBrowserService.BrowserRoot(onGetRoot.mRootId, onGetRoot.mExtras);
        }
