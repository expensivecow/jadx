        ...
        private static class Proxy implements IMediaControllerCallback {
            ...
            public void onPlaybackStateChanged(PlaybackStateCompat playbackStateCompat) throws RemoteException {
                ...
                try {
                    ...
                    if (playbackStateCompat != null) {
                        obtain.writeInt(i2);
                        playbackStateCompat.writeToParcel(obtain, i);
                    } else {
                        obtain.writeInt(i);
                    }
                    this.mRemote.transact(3, obtain, null, i2);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void onMetadataChanged(MediaMetadataCompat mediaMetadataCompat) throws RemoteException {
                ...
                try {
                    ...
                    if (mediaMetadataCompat != null) {
                        obtain.writeInt(i2);
                        mediaMetadataCompat.writeToParcel(obtain, i);
                    } else {
                        obtain.writeInt(i);
                    }
                    this.mRemote.transact(4, obtain, null, i2);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void onQueueTitleChanged(CharSequence charSequence) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(6, obtain, null, i2);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void onExtrasChanged(Bundle bundle) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(7, obtain, null, i2);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void onVolumeInfoChanged(ParcelableVolumeInfo parcelableVolumeInfo) throws RemoteException {
                ...
                try {
                    ...
                    if (parcelableVolumeInfo != null) {
                        obtain.writeInt(i2);
                        parcelableVolumeInfo.writeToParcel(obtain, i);
                    } else {
                        obtain.writeInt(i);
                    }
                    this.mRemote.transact(8, obtain, null, i2);
                } finally {
                    obtain.recycle();
                }
            }
