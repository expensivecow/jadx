...
public class AudioAttributesCompat {
    ...
    public static class Builder {
        ...
        public AudioAttributesCompat build() {
            if (AudioAttributesCompat.sForceLegacyBehavior || VERSION.SDK_INT < 21) {
                ...
                audioAttributesCompat.mAudioAttributesWrapper = obj;
    ...
    static {
        int i = 1;
        SUPPRESSIBLE_USAGES.put(5, i);
        int i2 = 2;
        SUPPRESSIBLE_USAGES.put(6, i2);
        SUPPRESSIBLE_USAGES.put(7, i2);
        SUPPRESSIBLE_USAGES.put(8, i);
        SUPPRESSIBLE_USAGES.put(9, i);
        SUPPRESSIBLE_USAGES.put(10, i);
        int i3 = 16;
    }
