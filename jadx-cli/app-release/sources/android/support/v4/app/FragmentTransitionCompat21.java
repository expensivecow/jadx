...
class FragmentTransitionCompat21 {
    ...
    public static void getBoundsOnScreen(View view, Rect rect) {
        ...
        int i = 0;
        int i2 = 1;
        rect.set(iArr[i], iArr[i2], iArr[i] + view.getWidth(), iArr[i2] + view.getHeight());
    }
    ...
    public static void scheduleRemoveTargets(Object obj, Object obj2, ArrayList<View> arrayList, Object obj3, ArrayList<View> arrayList2, Object obj4, ArrayList<View> arrayList3) {
        ...
        ((Transition) obj).addListener(new TransitionListener() {
            ...
            public void onTransitionStart(Transition transition) {
                ...
                if (obj5 != null) {
                    FragmentTransitionCompat21.replaceTargets(obj5, arrayList4, arrayList);
                }
                if (obj6 != null) {
                    FragmentTransitionCompat21.replaceTargets(obj6, arrayList5, arrayList);
                }
                if (obj7 != null) {
                    FragmentTransitionCompat21.replaceTargets(obj7, arrayList6, arrayList);
                }
            }
        });
    }
