...
public class Fragment implements ComponentCallbacks, OnCreateContextMenuListener, LifecycleOwner {
    ...
    static class AnimationInfo {
        ...
        AnimationInfo() {
            ...
            this.mEnterTransition = sharedElementCallback;
            this.mExitTransition = sharedElementCallback;
            this.mReenterTransition = Fragment.USE_DEFAULT_TRANSITION;
            this.mSharedElementEnterTransition = sharedElementCallback;
    ...
    public static Fragment instantiate(Context context, String str, @Nullable Bundle bundle) {
        ...
        try {
            ...
            int i = 0;
            Fragment fragment = (Fragment) cls.getConstructor(new Class[i]).newInstance(new Object[i]);
            if (bundle != null) {
    ...
    public void setUserVisibleHint(boolean z) {
        int i = 4;
        if (!this.mUserVisibleHint && z && this.mState < i && this.mFragmentManager != null && isAdded()) {
    ...
    public LoaderManager getLoaderManager() {
        ...
        boolean z = true;
        this.mCheckedForLoaderManager = z;
        this.mLoaderManager = this.mHost.getLoaderManager(this.mWho, this.mLoadersStarted, z);
        return this.mLoaderManager;
    }
    ...
    public void onCreate(@Nullable Bundle bundle) {
        ...
        if (this.mChildFragmentManager != null && !this.mChildFragmentManager.isStateAtLeast(z)) {
            this.mChildFragmentManager.dispatchCreate();
        }
    }
    ...
    void initState() {
        ...
        this.mInLayout = z;
        this.mRestored = z;
        this.mBackStackNesting = z;
        this.mFragmentManager = obj;
        this.mChildFragmentManager = obj;
        this.mHost = obj;
        this.mFragmentId = z;
        this.mContainerId = z;
        this.mTag = obj;
    ...
    private void callStartTransitionListener() {
        ...
        OnStartEnterTransitionListener onStartEnterTransitionListener2 = null;
        if (this.mAnimationInfo == null) {
            onStartEnterTransitionListener = onStartEnterTransitionListener2;
        } else {
            this.mAnimationInfo.mEnterTransitionPostponed = false;
            onStartEnterTransitionListener = this.mAnimationInfo.mStartEnterTransitionListener;
            this.mAnimationInfo.mStartEnterTransitionListener = onStartEnterTransitionListener2;
        }
