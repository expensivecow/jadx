...
public final class ShareCompat {
    ...
    public static class IntentBuilder {
        ...
        public Intent getIntent() {
            ...
            int i = 0;
            int i2 = 1;
            if (this.mStreams == null || this.mStreams.size() <= i2) {
                i2 = i;
            }
            ...
            if (i2 == 0 && equals) {
                ...
                if (this.mStreams == null || this.mStreams.isEmpty()) {
                    ...
                    this.mIntent.putExtra("android.intent.extra.STREAM", (Parcelable) this.mStreams.get(i));
                }
        ...
        private void combineArrayExtra(String str, ArrayList<String> arrayList) {
            ...
            int i = 0;
            int length = stringArrayExtra != null ? stringArrayExtra.length : i;
            Object obj = new String[(arrayList.size() + length)];
            arrayList.toArray(obj);
            if (stringArrayExtra != null) {
                System.arraycopy(stringArrayExtra, i, obj, arrayList.size(), length);
            }
        ...
        private void combineArrayExtra(String str, String[] strArr) {
            ...
            if (stringArrayExtra != null) {
                System.arraycopy(stringArrayExtra, i, obj, i, length);
            }
            System.arraycopy(strArr, i, obj, length, strArr.length);
