    ...
    private static class FrameMetricsApi24Impl extends FrameMetricsBaseImpl {
        ...
        OnFrameMetricsAvailableListener mListener = new OnFrameMetricsAvailableListener() {
            public void onFrameMetricsAvailable(Window window, FrameMetrics frameMetrics, int i) {
                ...
                int i2 = 0;
                int i3 = 8;
                if ((FrameMetricsApi24Impl.this.mTrackingFlags & i) != 0) {
                    FrameMetricsApi24Impl.this.addDurationItem(FrameMetricsApi24Impl.this.mMetrics[i2], frameMetrics.getMetric(i3));
                }
                int i4 = 2;
                if ((FrameMetricsApi24Impl.this.mTrackingFlags & i4) != 0) {
                    FrameMetricsApi24Impl.this.addDurationItem(FrameMetricsApi24Impl.this.mMetrics[i], frameMetrics.getMetric(i));
                }
                i = 4;
                int i5 = 3;
                if ((FrameMetricsApi24Impl.this.mTrackingFlags & i) != 0) {
                    FrameMetricsApi24Impl.this.addDurationItem(FrameMetricsApi24Impl.this.mMetrics[i4], frameMetrics.getMetric(i5));
                }
                if ((FrameMetricsApi24Impl.this.mTrackingFlags & i3) != 0) {
                    FrameMetricsApi24Impl.this.addDurationItem(FrameMetricsApi24Impl.this.mMetrics[i5], frameMetrics.getMetric(i));
                }
                i5 = 5;
                if ((FrameMetricsApi24Impl.this.mTrackingFlags & 16) != 0) {
                    FrameMetricsApi24Impl.this.addDurationItem(FrameMetricsApi24Impl.this.mMetrics[i], frameMetrics.getMetric(i5));
                }
                i = 7;
                int i6 = 6;
                if ((FrameMetricsApi24Impl.this.mTrackingFlags & 64) != 0) {
                    FrameMetricsApi24Impl.this.addDurationItem(FrameMetricsApi24Impl.this.mMetrics[i6], frameMetrics.getMetric(i));
                }
                if ((FrameMetricsApi24Impl.this.mTrackingFlags & 32) != 0) {
                    FrameMetricsApi24Impl.this.addDurationItem(FrameMetricsApi24Impl.this.mMetrics[i5], frameMetrics.getMetric(i6));
                }
                if ((FrameMetricsApi24Impl.this.mTrackingFlags & 128) != 0) {
                    FrameMetricsApi24Impl.this.addDurationItem(FrameMetricsApi24Impl.this.mMetrics[i], frameMetrics.getMetric(i2));
                }
                if ((FrameMetricsApi24Impl.this.mTrackingFlags & 256) != 0) {
                    FrameMetricsApi24Impl.this.addDurationItem(FrameMetricsApi24Impl.this.mMetrics[i3], frameMetrics.getMetric(i4));
                }
            }
        };
