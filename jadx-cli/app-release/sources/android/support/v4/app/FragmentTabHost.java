...
public class FragmentTabHost extends TabHost implements OnTabChangeListener {
    ...
    private void initFragmentTabHost(Context context, AttributeSet attributeSet) {
        ...
        this.mContainerId = obtainStyledAttributes.getResourceId(i, i);
    ...
    private void ensureHierarchy(Context context) {
        ...
        if (findViewById(i) == null) {
            ...
            int i2 = -1;
            addView(linearLayout, new LayoutParams(i2, i2));
            View tabWidget = new TabWidget(context);
            tabWidget.setId(i);
            i = 0;
            tabWidget.setOrientation(i);
            float f = 0.0f;
            linearLayout.addView(tabWidget, new LinearLayout.LayoutParams(i2, -2, f));
            tabWidget = new FrameLayout(context);
            tabWidget.setId(16908305);
            linearLayout.addView(tabWidget, new LinearLayout.LayoutParams(i, i, f));
            tabWidget = new FrameLayout(context);
            this.mRealTabContent = tabWidget;
            this.mRealTabContent.setId(this.mContainerId);
            linearLayout.addView(tabWidget, new LinearLayout.LayoutParams(i2, i, 1.0f));
        }
    }
