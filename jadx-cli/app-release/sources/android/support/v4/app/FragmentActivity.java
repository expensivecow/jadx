...
public class FragmentActivity extends BaseFragmentActivityApi16 implements OnRequestPermissionsResultCallback, RequestPermissionsRequestCodeValidator {
    ...
    protected void onCreate(@Nullable Bundle bundle) {
        ...
        this.mFragments.attachHost(fragmentManagerNonConfig);
        ...
        if (bundle != null) {
            ...
            if (bundle.containsKey("android:support:next_request_index")) {
                ...
                if (intArray == null || stringArray == null || intArray.length != stringArray.length) {
                    ...
                    for (int i2 = i; i2 < intArray.length; i2++) {
    ...
    void doReallyStop(boolean z) {
        ...
        if (!this.mReallyStopped) {
            this.mReallyStopped = z2;
            this.mRetaining = z;
            this.mHandler.removeMessages(z2);
            onReallyStop();
        } else if (z) {
            this.mFragments.doLoaderStart();
            this.mFragments.doLoaderStop(z2);
        }
    }
    ...
    public void onRequestPermissionsResult(int i, @NonNull String[] strArr, @NonNull int[] iArr) {
        ...
        if (i3 != 0) {
            ...
            if (findFragmentByWho == null) {
                ...
                findFragmentByWho.onRequestPermissionsResult(i & i2, strArr, iArr);
            }
        }
    }
    ...
    public void startActivityFromFragment(Fragment fragment, Intent intent, int i, @Nullable Bundle bundle) {
        ...
        if (i == i2) {
            try {
                ActivityCompat.startActivityForResult(this, intent, i2, bundle);
            } finally {
                this.mStartedActivityFromFragment = z2;
            }
        } else {
            BaseFragmentActivityApi14.checkForValidRequestCode(i);
            ActivityCompat.startActivityForResult(this, intent, ((allocateRequestIndex(fragment) + z) << 16) + (i & 65535), bundle);
            this.mStartedActivityFromFragment = z2;
        }
    }
    ...
    public void startIntentSenderFromFragment(Fragment fragment, IntentSender intentSender, int i, @Nullable Intent intent, int i2, int i3, int i4, Bundle bundle) throws SendIntentException {
        ...
        if (i5 == -1) {
            try {
                ...
                r9.mStartedIntentSenderFromFragment = z2;
            } catch (Throwable th) {
                Throwable th2 = th;
                r9.mStartedIntentSenderFromFragment = z2;
            }
            ...
            ActivityCompat.startIntentSenderForResult(r9, intentSender, ((allocateRequestIndex(fragment) + z) << 16) + (65535 & i5), intent, i2, i3, i4, bundle);
            r9.mStartedIntentSenderFromFragment = z2;
        }
    }
    ...
    private int allocateRequestIndex(Fragment fragment) {
        int i = 65534;
        if (this.mPendingFragmentActivityResults.size() >= i) {
            throw new IllegalStateException("Too many pending Fragment activity results.");
        }
        while (this.mPendingFragmentActivityResults.indexOfKey(this.mNextCandidateRequestIndex) >= 0) {
            this.mNextCandidateRequestIndex = (this.mNextCandidateRequestIndex + 1) % i;
        }
    ...
    void requestPermissionsFromFragment(Fragment fragment, String[] strArr, int i) {
        ...
        boolean z2 = true;
        try {
            this.mRequestedPermissionsFromFragment = z2;
            ActivityCompat.requestPermissions(this, strArr, ((allocateRequestIndex(fragment) + z2) << 16) + (i & 65535));
        } finally {
            this.mRequestedPermissionsFromFragment = z;
        }
    }
