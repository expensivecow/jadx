...
public abstract class SharedElementCallback {
    ...
    private static Bitmap createDrawableBitmap(Drawable drawable) {
        ...
        float f = 1.0f;
        float min = Math.min(f, ((float) MAX_IMAGE_SIZE) / ((float) (intrinsicWidth * intrinsicHeight)));
        if ((drawable instanceof BitmapDrawable) && min == f) {
        ...
        int i5 = 0;
        drawable.setBounds(i5, i5, intrinsicWidth, intrinsicHeight);
