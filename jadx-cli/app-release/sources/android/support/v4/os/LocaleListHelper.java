...
final class LocaleListHelper {
    ...
    static {
        int i = 0;
        sEmptyList = new Locale[i];
        sEmptyLocaleList = new LocaleListHelper(new Locale[i]);
    }
    ...
    public boolean equals(Object obj) {
        ...
        for (int i = z2; i < this.mList.length; i++) {
    ...
    LocaleListHelper(@NonNull Locale locale, LocaleListHelper localeListHelper) {
        ...
        while (true) {
            ...
            if (i4 >= i) {
                i4 = i2;
                break;
            } else if (locale.equals(localeListHelper.mList[i4])) {
                break;
            } else {
                i4++;
            }
        ...
        int i5 = 1;
        int i6 = (i4 == i2 ? i5 : i3) + i;
        Locale[] localeArr = new Locale[i6];
        localeArr[i3] = (Locale) locale.clone();
        int i7;
        if (i4 == i2) {
            i7 = i3;
            while (i7 < i) {
                i4 = i7 + 1;
                localeArr[i4] = (Locale) localeListHelper.mList[i7].clone();
                i7 = i4;
            }
        } else {
            i7 = i3;
            while (i7 < i4) {
                i2 = i7 + 1;
                localeArr[i2] = (Locale) localeListHelper.mList[i7].clone();
                i7 = i2;
            }
            for (i4 += i5; i4 < i; i4++) {
                localeArr[i4] = (Locale) localeListHelper.mList[i4].clone();
            }
        }
        StringBuilder stringBuilder = new StringBuilder();
        while (i3 < i6) {
            stringBuilder.append(LocaleHelper.toLanguageTag(localeArr[i3]));
            if (i3 < i6 - 1) {
                stringBuilder.append(',');
            }
            i3++;
