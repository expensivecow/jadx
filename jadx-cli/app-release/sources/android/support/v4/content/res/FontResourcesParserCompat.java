...
public class FontResourcesParserCompat {
    ...
    private static FamilyResourceEntry readFamilies(XmlPullParser xmlPullParser, Resources resources) throws XmlPullParserException, IOException {
        Object obj = null;
        xmlPullParser.require(2, obj, "font-family");
    ...
    public static List<List<byte[]>> readCerts(Resources resources, @ArrayRes int i) {
        ...
        if (i != 0) {
            ...
            if (obtainTypedArray.length() > 0) {
                list = new ArrayList();
                int i2 = 0;
                if ((obtainTypedArray.getResourceId(i2, i2) != 0 ? 1 : i2) != 0) {
                    for (i = i2; i < obtainTypedArray.length(); i++) {
                        list.add(toByteArrayList(resources.getStringArray(obtainTypedArray.getResourceId(i, i2))));
                    }
                } else {
    ...
    private static List<byte[]> toByteArrayList(String[] strArr) {
        ...
        for (int i2 = i; i2 < length; i2++) {
            arrayList.add(Base64.decode(strArr[i2], i));
        }
        return arrayList;
    }
    ...
    private static FontFileResourceEntry readFont(XmlPullParser xmlPullParser, Resources resources) throws XmlPullParserException, IOException {
        ...
        boolean z = false;
        boolean z2 = true;
        if (z2 != obtainAttributes.getInt(R.styleable.FontFamilyFont_fontStyle, z)) {
            z2 = z;
        }
        int resourceId = obtainAttributes.getResourceId(R.styleable.FontFamilyFont_font, z);
        String string = obtainAttributes.getString(R.styleable.FontFamilyFont_font);
        obtainAttributes.recycle();
        while (xmlPullParser.next() != 3) {
            skip(xmlPullParser);
        }
        return new FontFileResourceEntry(string, i, z2, resourceId);
    }
