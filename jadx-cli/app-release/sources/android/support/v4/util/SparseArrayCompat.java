...
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Exception block dominator not found, method:android.support.v4.util.SparseArrayCompat.clone():android.support.v4.util.SparseArrayCompat<E>, dom blocks: []
    ...
    public void append(int i, E e) {
        if (this.mSize == 0 || i > this.mKeys[this.mSize - 1]) {
            ...
            if (i2 >= this.mKeys.length) {
                ...
                Object obj2 = new Object[idealIntArraySize];
                int i3 = 0;
                System.arraycopy(this.mKeys, i3, obj, i3, this.mKeys.length);
                System.arraycopy(this.mValues, i3, obj2, i3, this.mValues.length);
                this.mKeys = obj;
                this.mValues = obj2;
            }
            this.mKeys[i2] = i;
