...
public final class MapTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public void write(JsonWriter jsonWriter, Map<K, V> map) throws IOException {
            if (map == null) {
                ...
                for (Entry entry : map.entrySet()) {
                    ...
                    int i3 = (toJsonTree.isJsonArray() || toJsonTree.isJsonObject()) ? 1 : i;
                    i2 |= i3;
                }
                if (i2 != 0) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> typeToken) {
        ...
        int i = 0;
        int i2 = 1;
        return new Adapter(gson, mapKeyAndValueTypes[i], getKeyAdapter(gson, mapKeyAndValueTypes[i]), mapKeyAndValueTypes[i2], gson.getAdapter(TypeToken.get(mapKeyAndValueTypes[i2])), this.constructorConstructor.get(typeToken));
    }
