...
public class ImageRequest extends Request<Bitmap> {
    ...
    private Response<Bitmap> doParse(NetworkResponse networkResponse) {
        ...
        if (this.mMaxWidth == 0 && this.mMaxHeight == 0) {
            ...
            decodeByteArray = BitmapFactory.decodeByteArray(bArr, z, bArr.length, options);
        } else {
            boolean z2 = true;
            options.inJustDecodeBounds = z2;
            BitmapFactory.decodeByteArray(bArr, z, bArr.length, options);
            ...
            if (decodeByteArray != null && (decodeByteArray.getWidth() > resizedDimension || decodeByteArray.getHeight() > resizedDimension2)) {
                Bitmap createScaledBitmap = Bitmap.createScaledBitmap(decodeByteArray, resizedDimension, resizedDimension2, z2);
